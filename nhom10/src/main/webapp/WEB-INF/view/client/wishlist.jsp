                        ...
                        <div class="container mt-5">
                            ...
                            <div class="container wishlist-container mt-4">
                                ...
                                <div class="wishlist-table">
                                    ...
                                    <!-- ITEM 1 -->
                                    <form action="/wishlist/addToCart" method="post" class="wishlist-row">
                                        <input type="hidden" name="productId" value="1">


                                        <div class="wishlist-col product d-flex align-items-center gap-3">
                                            <img src="/client/img/product-item1.jpg" class="product-img" alt="">
                                            <div>
                                                <p class="product-name mb-1">Sản phẩm 1</p>
                                                <p class="product-id">#1</p>
                                            </div>
                                        </div>


                                        <div class="wishlist-col price">1,000,000 VNĐ</div>


                                        <div class="wishlist-col status">
                                            <span class="badge">Còn hàng</span>
                                        </div>

                                        <div class="wishlist-col action">
                                            <button class="btn btn-sm" style="background-color: #52ff5ba6;">Thêm vào
                                                giỏ</button>
                                        </div>
                                    ...
                                    <form action="/wishlist/addToCart" method="post" class="wishlist-row">
                                        ...
                                        <div class="wishlist-col product d-flex align-items-center gap-3">
                                            <img src="/client/img/product-item2.jpg" class="product-img" alt="">
                                            <div>
                                                <p class="product-name mb-1">Sản phẩm 2</p>
                                                <p class="product-id">#2</p>
                                            </div>
                                        </div>


                                        <div class="wishlist-col price">2,500,000 VNĐ</div>


                                        <div class="wishlist-col status">
                                            <span class="badge" style="background-color: #f4414149;">Hết hàng</span>
                                        </div>
