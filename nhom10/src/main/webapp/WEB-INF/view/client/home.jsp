								...
								<div class="swiper-slide">
									<div class="container">
										<div class="row d-flex flex-wrap align-items-center">
											<div class="col-md-6">
												<div class="banner-content">
													<h1 class="display-2 text-uppercase text-dark pb-5">Công Nghệ Hack
														Bạn Không Thể Nhận</h1>
													<a href="shop.html"
														class="btn btn-medium btn-dark text-uppercase btn-rounded-none">Mua
														Sản Phẩm</a>
												</div>
											</div>
											<div class="col-md-5">
								...
								<div class="col-lg-3 col-md-6 pb-3">
									<div class="icon-box d-flex">
										...
										<div class="icon-box-content">
											...
											<p>Chúng tôi cung cấp dịch vụ chất lượng cao cho khách hàng.”</p>
										</div>
									</div>
								</div>
								<div class="col-lg-3 col-md-6 pb-3">
									<div class="icon-box d-flex">
										...
										<div class="icon-box-content">
											...
											<p>Sản phẩm được thiết kế chất lượng cao, đáng tin cậy.</p>
										</div>
									</div>
								</div>
								<div class="col-lg-3 col-md-6 pb-3">
									<div class="icon-box d-flex">
										...
										<div class="icon-box-content">
											...
											<p>Chất lượng đảm bảo, uy tín tuyệt đối.</p>
										</div>
									</div>
								</div>
								<div class="col-lg-3 col-md-6 pb-3">
									<div class="icon-box d-flex">
										...
										<div class="icon-box-content">
											...
											<p>Thanh toán an toàn, bảo mật tuyệt đối cho khách hàng.</p>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="col-lg-4 col-sm-12">
										...
										<div class="card-body text-uppercase">
											<div class="card-meta text-muted">
												<span class="meta-date">22 Tháng 2, 2023</span> <span
													class="meta-category">- Gadgets</span>
											</div>
											<h3 class="card-title">
												<a href="#">Những thiết bị thú vị năm 2023</a>
											</h3>
										</div>
									</div>
									<div class="col-lg-4 col-sm-12">
										...
										<div class="card-body text-uppercase">
											<div class="card-meta text-muted">
												<span class="meta-date">25 Tháng 2, 2023</span> <span
													class="meta-category">- Công Nghệ</span>
											</div>
											<h3 class="card-title">
												<a href="#">Công Nghệ Hack Bạn Không Thể Nhận</a>
											</h3>
										</div>
									</div>
									<div class="col-lg-4 col-sm-12">
								...
								<div
									...
									<div class="col-md-6 col-sm-12">
										<div class="display-header pe-3">
											...
											<p>Nhận tin tức, cập nhật và ưu đãi mới nhất trực tiếp vào email của bạn.
											</p>
										</div>
									</div>
										...
										<form class="subscription-form validate">
											<div class="input-group flex-wrap">
												...
												<button
													...
													type="submit" name="subscribe">Đăng Ký</button>
											</div>
										</form>
									</div>
								</div>
