...
<head>
    ...
    <!-- JQuery -->
    <link rel="stylesheet" href="${env}/client/bootstrap/js/jquery-3.6.0.min.js">
    <title>Sign In</title>
</head>
<body>
...
<!-- Bootstrap -->
<script src="${env}/client/bootstrap/js/popper.min.js"></script>
<script src="${env}/client/bootstrap/js/bootstrap.min.js"></script>
</body>
</html>