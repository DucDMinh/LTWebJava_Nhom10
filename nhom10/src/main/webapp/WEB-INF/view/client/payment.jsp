...
<body data-bs-spy="scroll" data-bs-target="#navbar"
	...
	<!-- Breadcrumb - Banner -->
	<section
		style="background: url(client/img/banner.jpg) center 15%/cover no-repeat; height: 300px;">
	...
	<section id="checkout" style="margin-bottom: 10%;">
		<div class="container">
			...
			<div class="position-relative p-3" style="z-index: 1055;">
				<div id="orderToast" class="toast align-items-center border-0"
					style="background: #09e310; position: absolute; top: -60px; right: -30px !important;"
					role="alert" aria-live="assertive" aria-atomic="true">
					<div class="d-flex">
						<div class="toast-body"
							style="color: rgb(255, 255, 255); font-size: 16px; font-weight: 600; line-height: 150%;">
							Order placed successfully! Thank you for shopping at Vegetable
							Shop.</div>
						<button type="button"
				...
				<div class="col-lg-7">
					<div class="checkout-section">
						...
						<form id="checkoutForm" class="row g-3">
							...
							<div class="col-md-4">
								<label class="form-label">Country / Region</label> <select
									class="form-select">
							...
							<div class="col-md-4">
								<label class="form-label">City / Province</label> <select
									class="form-select">
									<option selected>Select</option>
									<option>Hanoi</option>
							...
							<div class="col-12">
								<div class="form-check">
									<input class="form-check-input" type="checkbox"
										id="shipDifferent" /> <label class="form-check-label"
										for="shipDifferent"> Ship to a different address </label>
								</div>
							</div>
					...
					<div class="order-summary-card">
						...
						<div class="form-check">
							<input class="form-check-input" type="radio" name="paymentMethod"
								id="cod" checked /> <label class="form-check-label" for="cod">Cash
								on Delivery (COD)</label>
						</div>
						<div class="form-check">
							<input class="form-check-input" type="radio" name="paymentMethod"
								id="paypal" /> <label class="form-check-label" for="paypal">Pay
								with PayPal</label>
						</div>
						<div class="form-check">
							<input class="form-check-input" type="radio" name="paymentMethod"
								id="amazon" /> <label class="form-check-label" for="amazon">Pay
								with Amazon Pay</label>
						</div>

						<button id="placeOrder" class="place-order-btn"
							style="text-align: center;">Place Order</button>
					</div>
				</div>
				...
				<div class="d-flex flex-wrap">
					<figure class="instagram-item pe-2">
						<a href="https://templatesjungle.com/"
							...
							src="client/img/insta-item1.jpg" alt="instagram"
							class="insta-image">
							<div
					...
					<figure class="instagram-item pe-2">
						<a href="https://templatesjungle.com/"
							class="image-link position-relative"> <img
							src="client/img/insta-item2.jpg" alt="instagram"
							class="insta-image">
							<div
								class="icon-overlay position-absolute d-flex justify-content-center">
								<svg class="instagram">
					...
					<figure class="instagram-item pe-2">
						<a href="https://templatesjungle.com/"
							class="image-link position-relative"> <img
							src="client/img/insta-item3.jpg" alt="instagram"
							class="insta-image">
							<div
								class="icon-overlay position-absolute d-flex justify-content-center">
								<svg class="instagram">
					...
					<figure class="instagram-item pe-2">
						<a href="https://templatesjungle.com/"
							class="image-link position-relative"> <img
							src="client/img/insta-item4.jpg" alt="instagram"
							class="insta-image">
							<div
								class="icon-overlay position-absolute d-flex justify-content-center">
								<svg class="instagram">
					...
					<figure class="instagram-item pe-2">
						<a href="https://templatesjungle.com/"
							class="image-link position-relative"> <img
							src="client/img/insta-item5.jpg" alt="instagram"
							class="insta-image">
							<div
								class="icon-overlay position-absolute d-flex justify-content-center">
								<svg class="instagram">
