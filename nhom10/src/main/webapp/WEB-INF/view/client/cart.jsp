	...
	<section class="container-cart">
		...
		<div class="cart-grid mx-auto" style="width: 75%;">
				...
				<table class="cart-table">
					...
					<tbody id="cart-items">
						<tr data-price="980">
							<td>
								<div class="product-cell">
									<img class="product-thumb" src="./client/img/product-item1.jpg"
										alt="Green Bell Pepper">
									<div>
										<div class="product-title">iPhone XS Max</div>
										<div class="product-meta">100% new</div>
									</div>
								</div>
							</td>
							<td class="muted">$980</td>
							<td>
								<div class="qty-control">
									<button class="qty-decrease" disabled>
							...
							<td class="subtotal">$980</td>
							<td class="text-end"><span class="remove-btn" title="Remove">
						...
						<tr data-price="1111">
							<td>
								<div class="product-cell">
									<img class="product-thumb" src="./client/img/product-item2.jpg"
										alt="Red Bell Pepper">
									<div>
										<div class="product-title">iPhone XX Max</div>
										<div class="product-meta">100% new</div>
									</div>
								</div>
							</td>
							<td class="muted">$1111</td>
							<td>
								<div class="qty-control">
									<button class="qty-decrease" disabled>
										<i class="fa-solid fa-minus"></i>
			...
			<div class="summary-card">
				<h5
					style="font-weight: 500; font-size: 25px; line-height: 150%; letter-spacing: 0%;">
					Cart Summary</h5>
				<div class="summary-row">
					<span>Subtotal</span>
					<div id="summary-subtotal" class="muted">₫0</div>
				</div>
				<div class="summary-row">
